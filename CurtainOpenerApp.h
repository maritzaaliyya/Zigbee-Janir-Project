#ifndef __CURTAINOPENERAPP_H
#define __CURTAINOPENERAPP_H
 ...
 */
class INET_API CurtainOpenerApp : public ClockUserModuleMixin<ApplicationBase>, public UdpSocket::ICallback
{
  protected:
